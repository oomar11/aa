...
مثال: بريمير بياخد قائمة أسعار سيتي بريمير (فبراير 2025)
              للحلق والضلفة والباكتة والسوقاس — مفصلي وجرار في نظام واحد
            </p>
            <RadioList
              name="system"
          ...
          <Section title="الحديد">
            <p className="text-[11px] leading-relaxed text-muted">
              سيستم تسليح واحد — حلق مفصلي/جرار وضلفة شباك/باب/جرار كلها منه.
              الضبط والأسعار من الخامات ← حديد.
            </p>
          </Section>
